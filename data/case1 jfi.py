...
# 读取CSV文件
csv_file = './sigcomm-plot/data/Fairness-2030node-46tb.csv'  # 请替换为你的CSV文件路径
...
l1 = plt.plot(x, y1, color=colors[2], label='C3PDAG-20node-di2', marker='o', markersize=mark_size,linewidth=line_width, markerfacecolor=marker_facecolor)
l2 = plt.plot(x, y2, color=colors[0], label='C3P-20node-di2', marker='^', markersize=mark_size,linewidth=line_width, markerfacecolor=marker_facecolor)
...
plt.text(plt.xlim()[1], 0.95, 'P95', color='r', verticalalignment='center', backgroundcolor='white')
plt.axhline(y=0.99, color='r', linestyle='--')
plt.text(plt.xlim()[1], 0.99, 'P99', color='r', verticalalignment='center', backgroundcolor='white')
...
plt.savefig("./sigcomm-plot/5.2.2-2030node-46tb.pdf", format="pdf", dpi=1200, bbox_inches="tight")
