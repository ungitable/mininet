...
def myNetwork():
    ...
    for i in range(1, 31):
        ...
        lost5, total5 = lost_obj.get_rate(h5, 5005)
        lost6, total6 = lost_obj.get_rate(h6, 5006)
        lost7, total7 = lost_obj.get_rate(h7, 5007)
        lost8, total8 = lost_obj.get_rate(h8, 5008)

        lost9, total9 = lost_obj.get_rate(h9, 5009)
        lost10, total10 = lost_obj.get_rate(h10, 5010)
        lost11, total11 = lost_obj.get_rate(h11, 5011)
        lost12, total12 = lost_obj.get_rate(h12, 5012)
    ...
    plt.tight_layout()
    plt.savefig('/home/mininet/Desktop/pic/case5_plot1.png')
    plt.show()
    ...
    plt.savefig('/home/mininet/Desktop/pic/case5_plot2.png')
    plt.show()
