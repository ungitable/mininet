...
# 读取CSV文件
csv_file = '/home/mininet/mininet/data/case3 jfi.csv'  # 请替换为你的CSV文件路径
...
plt.savefig("/home/mininet/mininet/plot/case3 jfi.pdf", format="pdf", dpi=1200, bbox_inches="tight")
