...
# 读取CSV文件
csv_file = '/home/mininet/mininet/data/case2 performance.csv'  # 请替换为你的CSV文件路径
...
l1 = plt.plot(x, y1, color=colors[2], label='Group 1 E', marker='o', markersize=mark_size,linewidth=line_width, markerfacecolor=marker_facecolor)
l2 = plt.plot(x, y2, color=colors[0], label='Group 1 M', marker='^', markersize=mark_size,linewidth=line_width, markerfacecolor=marker_facecolor)
l3 = plt.plot(x, y3, color=colors[1], label='Group 2 E', marker="s", markersize=mark_size,linewidth=line_width, markerfacecolor=marker_facecolor, linestyle='--')
l4 = plt.plot(x, y4, color=colors[3], label='Group 2 M', marker="p", markersize=mark_size,linewidth=line_width, markerfacecolor=marker_facecolor, linestyle='--')
...
plt.legend(fontsize=20, frameon=False, prop={"family" : "Times New Roman", 'weight':'bold'}, loc='lower right')
...
plt.savefig("/home/mininet/mininet/plot/case2 compare.pdf", format="pdf", dpi=1200, bbox_inches="tight")
