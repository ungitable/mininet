...
y1 = df.iloc[:51, 17] * 10 # 第二列作为第一个折线的 y 轴数据
y2 = df.iloc[:51, 18] * 10 # 第三列作为第二个折线的 y 轴数据
y3 = df.iloc[:51, 19] * 10  # 第四列作为第三个折线的 y 轴数据
y4 = df.iloc[:51, 20] * 10 # 第四列作为第三个折线的 y 轴数据
...
l1 = plt.plot(x, y1, color=colors[2], label='no E', marker='o', markersize=mark_size,linewidth=line_width, markerfacecolor=marker_facecolor, linestyle='--')
l2 = plt.plot(x, y2, color=colors[0], label='no M', marker='^', markersize=mark_size,linewidth=line_width, markerfacecolor=marker_facecolor, linestyle='--')
l3 = plt.plot(x, y3, color=colors[1], label='fanya E', marker="s", markersize=mark_size,linewidth=line_width, markerfacecolor=marker_facecolor)
l4 = plt.plot(x, y4, color=colors[3], label='fanya M', marker="p", markersize=mark_size,linewidth=line_width, markerfacecolor=marker_facecolor)
...
plt.savefig("/home/mininet/mininet/plot/case6 compare.pdf", format="pdf", dpi=1200, bbox_inches="tight")
