...
# 读取CSV文件
csv_file = '/home/mininet/mininet/data/case1 performance.csv'  # 请替换为你的CSV文件路径
...
plt.savefig("/home/mininet/mininet/plot/case1 performance.pdf", format="pdf", dpi=1200, bbox_inches="tight")
